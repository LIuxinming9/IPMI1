	        ...
	        <div class='row-fluid' id='content-wrapper'>
	            <div class='span12'>
	            	 <nav class="breadcrumb">
						<i class="Hui-iconfont">&#xe67f;</i>  告警管理 <span class="c-gray en">&gt;</span> 实时告警 <span class="c-gray en">&gt;</span> 轻微告警 
					</nav> 
		...
		<div id="resultDiv" class="mt-20" style="margin-top:-20px;">
				<div class="cl pd-5 bg-1 bk-gray"> 
            		...
            		<ul class="l pull-right">
           			...
           			<ul class="l pull-right">
           				<li style="color:black;background-color: DeepSkyBlue;border: 5px solid DeepSkyBlue;list-style-type:disc;">
...
function showSlight() 
{
	$.ajax({
        type:"POST",
        url:"${pageContext.request.contextPath}/warncurrent/warncurrentslightDiv",
        data:{},
        success : function(msg) {
        	$('#resultDiv').html(msg);
        },
