	...
	<div class='container-fluid'>
	        <div class='row-fluid' id='content-wrapper'>
	            <div class='span12'>
	            	 <nav class="breadcrumb">
						<i class="Hui-iconfont">&#xe67f;</i>  告警管理 <span class="c-gray en">&gt;</span> 实时告警  <span class="c-gray en">&gt;</span> 全部告警 
					</nav> 
		...
		<div id="resultDiv" class="mt-20" style="margin-top:-20px;">
				<div class="cl pd-5 bg-1 bk-gray"> 
			        ...
			        <%-- <ul class="l pull-right">
           				<li style="color:black;background-color:Cyan ;border: 5px solid Cyan ;list-style-type:circle;">
            				<a href='${pageContext.request.contextPath}/warncurrent/jtopo' >
			        			<span>查看拓扑图</span></a></li></ul>	 --%>		
        		</div>
