	        ...
	        <div class='row-fluid' id='content-wrapper'>
	            <div class='span12'>
	            	 <nav class="breadcrumb">
						<i class="Hui-iconfont">&#xe67f;</i>  告警管理 <span class="c-gray en">&gt;</span> 实时告警 <span class="c-gray en">&gt;</span> 严重告警 
					</nav> 
...
function showSerious() 
{
	$.ajax({
        type:"POST",
        url:"${pageContext.request.contextPath}/warncurrent/warncurrentseriousDiv",
        data:{},
