	            ...
	            <div class='span12'>
	            	...
	            	<div class="page-container">
						...
						<div class="cl pd-5 bg-1 bk-gray"> 
		            		<%-- <ul class="l pull-right"><li onclick="showExigence();" style="color:black;background-color: OrangeRed;border: 5px solid OrangeRed;list-style-type:circle;">紧急告警：${intlist.get(3)}</li></ul>
		            		<ul class="l pull-right"><li onclick="showSerious();" style="color:black;background-color: Lime;border: 5px solid Lime;list-style-type:circle;">严重告警：${intlist.get(2)}</li></ul>
	            			<ul class="l pull-right"><li onclick="showSlight();" style="color:black;background-color: DeepSkyBlue;border: 5px solid DeepSkyBlue;list-style-type:circle;">轻微告警：${intlist.get(1)}</li></ul>
	            			<ul class="l pull-right"><li onclick="showAll();" style="color:black;background-color: LightGray ;border: 5px solid LightGray ;list-style-type:disc;">全部告警：${intlist.get(0)}</li></ul> --%>
...
function showExigence()
{
	$.ajax({
        type:"POST",
        url:"${pageContext.request.contextPath}/warncurrent/warncurrentexigence",
        data:{},
        success : function(msg) {
        	$('#resultDiv').html(msg);
        },
